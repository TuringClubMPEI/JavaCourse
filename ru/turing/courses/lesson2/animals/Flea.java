...
public class Flea extends Animal{
    ...
    public void tryKill() {
        if (!isAlive) {
            ...
            if (isImmortal) {
                System.out.printf("%s cannot be killed, it's freaking flea!\n", name);
            } else {
    ...
    public void tryJump(float height) {
        if (!isAlive) {
    ...
    public Flea(String name, boolean isFlying, boolean isSwimming, int numberOfPaws, int age, float jumpHeight, boolean isAlive, boolean isImmortal) {
