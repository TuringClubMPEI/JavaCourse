...
import static ru.turing.courses.lesson2.Zheleznov.UserProcessor.userProcessor;
...
import ru.turing.courses.lesson2.Zheleznov.Study.Studying;
import ru.turing.courses.lesson2.Zheleznov.Study.Student9thClass;import ru.turing.courses.lesson2.Zheleznov.Study.Student11thClass;
...
//прошу ввести данные пользователя с клавиатуры
        ...
        //userProcessor(dateOfBirth, address);
